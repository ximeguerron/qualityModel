# Welcome 
In this site, you can find relevant information attached to the article the **_Operationalized quality model for cloud services: A model at runtime−based approach_**. 
The research methodology and results of case study are detailed in the next sections.

## Index

PLANNING
1. [Search Protocol](#Protocolo)
2. [Summary of cloud service metrics](#metrics)
3. [Sources](#estudios)
...
## 2. Summary of cloud service metrics
 {#metrics}

A brief summary of cloud service metrics is shown below:

| Capacity of cloud service  | Maximum capacity                                     | measure the upper limit of the number of requests that a service is capable of processing.                                                                                                                                 | S30                                                        |
|----------------------------|------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------|
| Capacity provisioned       | Capacity provisioned                                 | measures the recorded capacity provisioned for a time interval.                                                                                                                                                            | S61                                                        |
| Computing capacity         | Computing capacity                                   | measures the ratio between actual and expected use of the resource.                                                                                                                                                        | S65                                                        |
| Connections                | Active connections                                   | measures the number of active connections                                                                                                                                                                                  | S35                                                        |
| Bandwidth                  | Bandwidth                                            | measures the available communication resources.                                                                                                                                                                            | S23, S36, S69, S65, S09                                    |
| Packets in                 | Packets in                                           | measures the number of input packets.                                                                                                                                                                                      | S35                                                        |
| Packets out                | Packets out                                          | measures the number of output packets.                                                                                                                                                                                     | S35                                                        |
| Server capacity            | Monitored processes number                           | measures the number of monitored processes.                                                                                                                                                                                | S35                                                        |
| Storage capacity           | Storage capacity                                     | measures the storage capacity with virtual disks to serve many user groups.                                                                                                                                                | S09, S10, S24, S36, S69                                    |
| Application capacity       | Application capacity                                 | measures the capacity of application by the number of request per minute.                                                                                                                                                  | S69                                                        |
| CPU capacity VM            | Number of CPU                                        | measures the computing using  the number of CPU cores assigned to the monitored VM.                                                                                                                                        | S51, S69                                                   |
| Overprovisioning           | Overprovisioning resource                            | measures provisioning resource is over the needs, usually when the SLA and QoS are not optima                                                                                                                              | S35                                                        |
| Underprovisioning          | Underprovisioning resource                           | measures provisioning resource is under the needs, usually when the SLA and QoS are not optima                                                                                                                             | S35                                                        |
| Service scalability        | Scalability rate                                     | measures the capability of increasing the computing capacity of a service provider’s computer system and system’s ability to process more users’ requests, operations or transactions in a given time interval.            | S49                                                        |
| Scalability coverage       | Coverage of scalability                              | measures the average amount of allocated resources among the amount of request resources. It reflects the ability of the cloud to fit the increase of the workload.                                                        | S26, S02, S44, S53                                         |
| Efficiency                 | Resource efficiency                                  | measures the efficiency of resources in terms of time behavior and resource utilization                                                                                                                                    | S44, S53                                                   |
| Energy efficiency          | Average energy consumption per request               | measures the average energy consumption per request.                                                                                                                                                                       | S31                                                        |
| Video quality              | Quality shifting frequency                           | measures how frequently the resolution shifting occurs in the video player.                                                                                                                                                | S64                                                        |
| Disk utilization           | Disk utilization                                     | measures the ratio of current occupied disk resource to the total disk resource.                                                                                                                                           | S70                                                        |
| VM migrations              | VM migrations                                        | measures how much migrations happened during VM allocation.                                                                                                                                                                | S01                                                        |
| Connections utilization    | Connections utilization                              | measures the percentage of current connections related to total available connections.                                                                                                                                     | S35                                                        |
| Service sustainability     | Service sustainability                               | measures the number of components that are reusable without any modification despite the evolution of the user requirements. The possible evolution of the user requirements is provided in terms of characteristics.      | S30                                                        |
| Response time              | Response time                                        | measures the time it takes when a user sends a request to the cloud and receives a response from a cloud solution.This includes the processing time at SaaS and IaaS cloud types and network transmission time.            | S21, S40, S42, S49, S58                                    |
| Latency                    | Latency                                              | measures the difference time for a user’s request to be handled by the relevant service. This time only depends on the performance and the network conditions when the user’s request is sent to the service provider.     | S26, S58, S36, S61, S23                                    |
| Execution time             | Execution time                                       | measures the time elapsed during program or job execution, knowing the MIPS(Million of instructions per second) capacity of VMs and the number of instructions (in Million of Instructions) that VMs have to execute.      | S30, S36, S13, S19                                         |
| Data transfer              | Data transfer rate                                   | measures how fast the cloud service is provided.                                                                                                                                                                           | S26                                                        |
| Density App                | Density App                                          | measures the number of application servers running on a system.                                                                                                                                                            | S61                                                        |
| Network rate               | netPacketsIn                                         | measures the packets in per second.                                                                                                                                                                                        | S70                                                        |
| VM availability            | Ratio of available VMs to accepted VM requests(Rava) | measures the mean ratio of the number of available VMs to the total number of accepted VM requests in steady state.                                                                                                        | S62                                                        |
| Service Availability       | Availability                                         | measures the ability of a cloud service users to access the cloud resources. The ratio of the time a service component is functional to the total time.                                                                    | S61, S65, S72                                              |
| Availability time          | Uptime ratio                                         | measures the percentage of uptime duration over a defined interval duration.                                                                                                                                               | S81, S58, S84, S82, S49, S21, S13, S83, S69, S78, S36, S12 |
| Mean time between failures | Mean time between failures(MTBF)                     | measures the time between consecutive failures. i.e. return time taken to operate under the stated conditions.                                                                                                             | S09, S10                                                   |
| I-Frame loss rate          | I-Frame loss rate                                    | measures the rate between number of I-frames lost and sent.                                                                                                                                                                | S26                                                        |
| Robustness of service      | Robustness                                           | measures the number of services affected by a failure in a component of the cloud service.                                                                                                                                 | S30                                                        |
| Success operation          | Success rate                                         | measures of success rate of a work/task/job accepted by the cloud service in a time interval.                                                                                                                              | S50, S27                                                   |
| Resiliency                 | Recovery rate                                        | measures the recovery rate or the capability to recover from failure or disaster.                                                                                                                                          | S36                                                        |
| Dangerous data             | Percentage of dangerous data resources               | measures the percentage of dangerous data resources residing on systems.                                                                                                                                                   | S65                                                        |
| Access Control             | Access state                                         | indicates the access control state.                                                                                                                                                                                        | S48                                                        |
| Alarms monitored           | Number of  alarms monitored                          | measures the number of fake alarms monitored by corporate security.                                                                                                                                                        | S65                                                        |
| Data integrity             | Data integrity of resources                          | measures the ratio of the number of jobs whose data integrity was preserved by the resource over a period to the number of jobs successfully completed by the resource.                                                    | S50, S27, S39                                              |
| Service integrity          | Service integrity                                    | measures the probability of an attack occurring in a time interval and the probability of repelling the attack in the cloud service                                                                                        | S65                                                        |
| Defects                    | Number of defects                                    | measures the number of defects reported per cloud service.                                                                                                                                                                 | S65                                                        |
| Flexibility                | Flexibility                                          | measures the capability of the service provider to regulate the changes in cloud services according to the customers’ requests.                                                                                            | S07                                                        |
| Variability                | Coverage of variability                              | measures variability by considering how many variation points can be customized by cloud service users.                                                                                                                    | S53                                                        |
| Testing time               | Testing time                                         | measures the time required to test the cloud service, includes time to prepare the test environment and the execution time of a test suite.                                                                                | S65                                                        |
| Service adaptability       | Time to adapt                                        | measures the time taken to adapt to changes or upgrading the cloud service to a higher level based on customer requests.                                                                                                   | S24                                                        |
| Operating systems support  | Operating systems support                            | identifies the different operating systems(OS) supported by service providers, and applications can rank providers by required OS support.                                                                                 | S10                                                        |
| Pertinence of service      | Pertinence value                                     | measures the relationship of the service unit, between the expected value and the value returned by the service to the user.                                                                                               | S30                                                        |
| Suitability                | Suitability of non-essential features                | measures the relationship between non-essential features provided by the service and those required by the customer.                                                                                                       | S24                                                        |
| Accuracy of service        | Accuracy frequency                                   | measures the frequency of non-compliance with the committed values of the SLA.                                                                                                                                             | S24, S30                                                   |
| Learnability effort        | Average time to learn                                | measures the average time experienced by previous users to learn the cloud service.                                                                                                                                        | S24                                                        |
| Understandability effort   | Average time to understand                           | measures the relationship between the number of fields with unacceptable readability compared to the total number of fields.                                                                                               | S53                                                        |
| Operability effort         | Average time to operate                              | measures the average time experienced by the previous users to operate the cloud service.                                                                                                                                  | S24                                                        |
| User interfaces supported  | User interfaces                                      | describes how easy, efficient, and enjoyable the interface to a cloud service is to use, or assesses the ease of invocation if the functionality of a cloud service is exposed as application programming interface (API). | S82, S83                                                   |
| Interoperability platforms | Interoperability platforms                           | measures the ratio of interoperability platforms provided while Interact with other services offered either by the same provider or other providers.                                                                       | S24                                                        |
| Service interoperability   | Interoperability resources                           | measures services interoperability between different development environments used to implement the cloud services.                                                                                                        | S49                                                        |
| Security certification     | Certification                                        | defines the types of certification facilities.                                                                                                                                                                             | S10                                                        |
| Scaling cost               | Average cost of scaling down                         | evaluates the cloud resource elasticity and measures the average cost of scaling down.                                                                                                                                     | S35                                                        |
|                            | Average cost of scaling up                           | evaluates the cloud resource elasticity and measures the average cost of scaling up.                                                                                                                                       | S35                                                        |
| Maintenance cost           | Maintenance cost                                     | calculates the maintenance cost in terms of node capacity and the budget of node restore.                                                                                                                                  | S46                                                        |
| Security cost              | Security cost                                        | measures the percentage of the cost of the security of the service with respect to the total company revenue.                                                                                                              | S46                                                        |
# Conducting
## 3. Source {#estudios}
...
## 5. Monitoring results {#monitoring}
